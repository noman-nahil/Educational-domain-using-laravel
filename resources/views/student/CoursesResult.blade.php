                                                ...
                                                <div class="col-md-8">
                                                  <form>
                                                    <div class="row">
                                                        @csrf
                                                        <div>
                                                            <input type="button" id="search" value="search" class="btn btn-primary btn-lg px-3">
                                                        </div>
                                                    </div>
                                                  <div class="row">
                                                    @foreach ($users as $i )
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <input type="text" id="courseName" name="courseName" value="{{$i->courseName}}" class="form-control form-control-lg" disabled> 
                                                    </div>
                                                    <div class="col-md-12 form-group">
                                                        <label for="grade">Grade</label>
                                                        <input type="text" id="grade" name="grade" value="{{$i->grade}}" class="form-control form-control-lg" disabled> 
                                                    </div>
                                                    @endforeach
                                                </div>  
                                                </div>
