...
>>>>>>> e4024cf394f3022ba5ec573316edfa1aac74d6c5
    ...
    <table class="table">
      ...
      <tbody>
			<tr>
        <td></td>
       <td><input type="text"  name="Midterm" class="form-control form-control-lg" value="{{ $list }}"></td>
       <td><input type="text"  name="Finalterm" class="form-control form-control-lg" value="{{ }}"></td>
    </tr>
      </tbody>
    </table>
